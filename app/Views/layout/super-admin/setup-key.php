          ...
          <div class="col-md-6">
            ...
            <div class="card ">
              <div class="card-header">
                <h3 class="card-title text-center fs-1"> Generate Secret Key</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validation()" method="post" action="<?= $formUrl; ?>">
                ...
                <div class="card-body">
                  ...
                  <p>Your Secret Key is: <span class="fw-bold"><?= $secretKey ?></span> </p>
                  </div>
                  <div class="mb-3">
                   <input type="hidden" name="secret_key" id="secret_key" value="<?=  $secretKey?>">
