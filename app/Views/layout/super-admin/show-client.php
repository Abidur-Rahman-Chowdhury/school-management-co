          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title mb-0">Show Client</h5>
              </div>
              <div class="card-body">
                ...
                <form action="<?= $formUrl ?>" method="post">
                            ...
                            <div id='suggestingEmail' class='ClasssuggestingEmpIdList'>
                                    ...
                                    <div class="form-group">
                                        <div class="">
                                            <label>Phone</label>
                                            <input class="form-control" onkeyup="getClientPhone(this.id, this.value)" autocomplete="off" type="text" id="contact_number" name="contact_number" value="" />
                                            <?php
                                            $tableTR = '';
                            ...
                            <div id='suggestingPhone' class='ClasssuggestingEmpIdList'>
                                    ...
                                    <div>
                                        <button class="btn btn-primary ml-2" style="margin-top:27px;" type="submit">Search</button>
                                    </div>
                                </div>
                        ...
                        <tr>
                          ...
                          <td class="">
                            <div class="d-flex gap-2 justify-content-center">
                              <a href="<?= base_url('/super-admin/edit-client/' . $value['id']); ?>"><i style="font-size: 20px;" class='bx bxs-edit'></i></a>
                              <?php $actDec = $value['is_active'] == Constants::DEACTIVE ? Constants::ACTIVE  : Constants::DEACTIVE  ?>
                              <?php if ($value['is_active'] == Constants::ACTIVE) : ?>
                                <button onclick="actDecData('client-act-dec',this.value,<?php echo json_encode($actDec) ?>,'client','super-admin/view-clients')" type="button" value="<?= $value['id'] ?>" class="form-check form-switch border-0 out-line-0 bg-transparent"><input class="form-check-input" type="checkbox" role="switch" id="SwitchCheck4" checked=""></button>
                              <?php endif ?>
                              <?php if ($value['is_active'] == Constants::DEACTIVE) : ?>
                                <button onclick="actDecData('client-act-dec',this.value,<?php echo json_encode($actDec) ?>,'client','super-admin/view-clients')" type="button" value="<?= $value['id'] ?>" class="form-check form-switch border-0 bg-transparent"><input class="form-check-input" type="checkbox" role="switch" id="SwitchCheck4"></button>
                              <?php endif ?>
                            </div>
                          </td>
...
<script>
  ...
  function getClientName(id, val) {
    ...
    function fill_phone_id_by_tanent(id, phone) {
        document.getElementById('contact_number').value = phone;
        document.getElementById('user_id').value = id;
